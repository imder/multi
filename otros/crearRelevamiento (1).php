          ...
          <form id="form" action="php/regRelevamiento.php" class="formulario" name="formulario_registro" method="post">
                 <div class="input-group mb-2">
                  ...
                  <div class="input-group mb-2">
                      ...
                      <input type="text" class="form-control" name="representante" id="repre" required placeholder="Representante">
                  </div>
                  ...
                  <div class="input-group mb-2">
                      ...
                      <input type="email" class="form-control" name="correoR" id="correoR" placeholder="Correo">
                  </div>
                  ...
                  <div class="input-group mb-2">
                      ...
                      <input type="text" class="form-control" name="lugar" id="lugar" required placeholder="Lugar">
                  </div>
                  <?php
                 include("php/conexion.php");

                 $query5="SELECT * FROM servicios";
                 ...
                 $rows5 = mysqli_num_rows($resultado5);   
                     ...
                     <div class="input-group mb-2">
                            <div class="input-group-prepend">
                              <div class="input-group-text">Servicio</div>
                               ...
                               <select class="form-control" name="servicio" type="text" placeholder="">
                        <?php 
                           while($dats5=mysqli_fetch_array($resultado5)){
                           echo" <option value='".$dats5["idServicio"]."'>".$dats5["Descripcion"]."</option>";
                            }
                        }
                   ...
                   <a href="#" class="btn btn-outline-danger btn-block" onclick="findMe();"><i class="fas fa-map-marker-alt"></i> Mostrar Ubicacion</a>
