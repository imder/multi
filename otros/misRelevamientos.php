...
<html lang="es">
  ...
  <body>
      ...
      <nav class="navbar navbar-dark navbar-expand-lg " style="background-color: #1C2833;">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
          <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link" href="#">Crear relevamiento</a>
            </li>
          ...
          $fil = mysqli_num_rows($resi);
            ...
            if($fil != 0){
                while($dat=mysqli_fetch_array($resi)){
                  ...
                  if($_SESSION['password']==$dat['usuario']){
                    if($dat['nivel'] == 3){
        ...
        ?>
              ...
              <li class="nav-item"><a class="nav-link" href="php/reporte.php">Reportes</a></li>
          </ul>
       ...
       <!-- 
        ...
        <input class="form-control mr-sm-2" type="text" name="busqueda" id="busqueda">
        <img  class="profile-img-card" src="images/icons8-30.png" width="38" height="38" />
      </form>
      </div>
     -->
    </div>
    ...
    <!-- Navbar content Barra inferior

     <nav class="navbar navbar-dark bg-success" id="inferior" style="position: fixed;">
    <a href="crearRelevamiento.html" src=""></a>
