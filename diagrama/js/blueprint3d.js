...
(function (BP3D) {
    ...
    (function (Core) {
        ...
        var Utils = (function () {
            ...
            /** Determina la distancia de un punto desde una línea.
            ...
            /** Obtiene la proyección de un punto en una línea.
            ...
            /**  Obtiene el ángulo entre 0,0 -> x1, y1 and 0,0 -> x2, y2 (-pi a pi)
             * @returns The angle.
             */
            ...
            /** Comprueba si una matriz de puntos es en el sentido de las agujas del reloj.
             * @param points Es una matriz de puntos con atributos x, y
             * @returns Verdadero si es en sentido horario.
             */
            ...
            /** ambos argumentos son arreglos de esquinas con atributos x, y */
            ...
            /** Corners es una matriz de puntos con atributos x, y */
            ...
            /**
             @param corners Es una matriz de puntos con atributos x, y
            ...
            */
            Utils.pointInPolygon = function (x, y, corners, startX, startY) {
                ...
                // intersecciones impares significa que el punto está en el polígono
                return ((tIntersects % 2) == 1);
            };
            /** Comprueba si todas las esquinas de los interiores están dentro del polígono descrito por outsideCorners */
            ...
            /** Comprueba si las esquinas de las primeras esquinas están dentro del polígono descrito por secondCorners */
            ...
            /** Eliminar elementos en la matriz si func (element) devuelve verdadero */
            ...
            /** Cambia los elementos en una matriz por turno (entero positivo) */
            ...
            /** Devoluciones en los elementos únicos en arr */
            ...
            /** Eliminar valor de la matriz, si está presente */
...
(function (BP3D) {
    var Core;
    (function (Core) {
        /** Dimensionamiento en pulgadas. */
        Core.dimInch = "inch";
        /** Dimensionamiento en metros */
        Core.dimMeter = "m";
        /** Dimensionamiento en centimetros. */
        Core.dimCentiMeter = "cm";
        /** Dimensionamiento en milimetros. */
        Core.dimMilliMeter = "mm";
        /** Funciones de dimensionamiento. */
        var Dimensioning = (function () {
            function Dimensioning() {
            }
            /** Convierte cm en cadena de acotación.
             * @param cm Valor de centímetro a convertir.
             * @returns Representación de cadenas.
             */
            ...
            /**    muestra la longitud de paredes en metros           */
                    case Core.dimMeter:
                    default:
                       var metros = Math.round(10 * cm) / 1000;
                       var metros2 = metros.toFixed(1);
                        return "" + metros2 + " m";
                }
            };
            return Dimensioning;
...
(function (BP3D) {
    ...
    (function (Core) {
        // GENERAL:
        /** La unidad de dimensionamiento para mediciones de planos 2D*/
        Core.configDimUnit = "dimUnit";
        // WALL:
        /** La altura inicial de la pared en cm. */
        Core.configWallHeight = "wallHeight";
        /** El grosor inicial de la pared en cm. */
        Core.configWallThickness = "wallThickness";
        /** Configuración global para personalizar todo el sistema.  */
        var Configuration = (function () {
            ...
            /** Obtenga un parámetro de configuración de cadena */
            ...
            /** Obtenga un parámetro de configuración numérica. */
            ...
            /** Datos de configuración cargados desde / almacenados a extern. */
            Configuration.data = {
...
(function (BP3D) {
    ...
    (function (Items) {
        /**
         * Un item es una entidad abstracta para todo lo que se coloca en la escena,
         * p.ej. en las paredes o en el piso.
         */
...
(function (BP3D) {
    ...
    (function (Model) {
        ...
        /**
         * Las esquinas (Corners) se usan para definir Paredes.
         */
        var Corner = (function () {
            /** Construye una esquina.
             * @param floorplan The associated floorplan.
             * @param x X coordinate.
             * @param y Y coordinate.
             * @param id Una identificación única opcional. Si no está configurado, creado internamente.
             */
            function Corner(floorplan, x, y, id) {
                ...
                this.y = y;
                this.id = id;
                /** Matriz de paredes de inicio. */
                this.wallStarts = [];
                /** Matriz de paredes finales. */
                this.wallEnds = [];
                /** Devolución de llamada para ser despedido en movimiento. */
            ...
            /** Agregar función a devoluciones de llamadas movidas.
             * @param func La función que se agregará.
            */
            Corner.prototype.fireOnMove = function (func) {
                this.moved_callbacks.add(func);
            };
            /** Agregar función a devoluciones de llamadas eliminadas.
             * @param func The function to be added.
             */
            Corner.prototype.fireOnDelete = function (func) {
                this.deleted_callbacks.add(func);
            };
            /** Agregar función a devoluciones de llamadas de acción.
             * @param func The function to be added.
             */
...
(function (BP3D) {
    ...
    (function (Model) {
        /**
         *Half Room es creado por Room.
          *
          * Una vez que las habitaciones han sido identificadas, se crean Half Edges para cada pared interior.
          *
          * Una pared puede tener dos medios bordes si es visible desde ambos lados.
         */
...
(function (BP3D) {
    var Model;
    (function (Model) {
        /** Textura predeterminada que se utilizará si no se proporciona nada. */
        var defaultRoomTexture = {
            url: "rooms/textures/hardwood.png",
            scale: 400
        };
        /**
         * Una habitación es la combinación de un plano con un plano de planta.
         */
        var Room = (function () {
            /**
             *  ordered CCW
            ...
            function Room(floorplan, corners) {
                ...
                /** planos de planta para pruebas de intersección */
            ...
            /**
             * textureStretch siempre es cierto, solo un argumento para la coherencia con las paredes
             */
            ...
            /**
             * Rellena el medio borde de cada muro relacionado con esta sala
              * esto crea una elegante lista de bordes doblemente conectados (DCEL)
             */
...
(function (BP3D) {
    ...
    (function (Model) {
        ...
        /**
         * Un Plano representa un número de Muros, Esquinas y Salas.
         */
        var Floorplan = (function () {
            ...
            function Floorplan() {
                ...
                /**
                * Las texturas del piso son propiedad del plano, porque los objetos de la sala son
                 * destruido y creado cada vez que cambiamos el plano.
                 * floorTextures es un mapa de los UUID de la habitación (cadena) a un objeto con
                 * URL y atributos de escala.
                */
                this.floorTextures = {};
            }
            // hack
        ...
        var FloorplannerView = (function () {
            ...
            FloorplannerView.prototype.drawEdgeLabel = function (edge) {
                ...
                if (length < 60) {
                    ...
                    //no dibujar etiquetas en las paredes este corto
                    return;
                }
...
(function (BP3D) {
    ...
    (function (Three) {
        Three.Controller = function (three, model, camera, element, controls, hud) {
            ...
            var selectedObject;
            var mouseDown = false;
            var mouseMoved = true; // has mouse moved since down click
